...
import { toggleMenuVisibility } from "../utils/store/slices/appSlice";
...
const Header = () => {
  ...
  return (
    <div className="grid grid-flow-col">
      <div className="flex justify-center items-center col-span-1 w-fit">
        <img
      ...
      <div className="flex items-center col-span-10 justify-center">
        <input
          type="text"
          className="w-1/2 h-8 border-2 border-gray-600 rounded-l-full py-1 px-3 flex items-center justify-center"
        />
        <button className="h-8 bg-red-500 text-white rounded-lg cursor-pointer px-3 py-1 rounded-r-full">
          Search
        </button>
      </div>
      <div className="flex justify-center items-center col-span-1 w-fit">
